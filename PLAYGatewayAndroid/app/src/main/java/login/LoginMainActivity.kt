...
import com.prilux.playgatewayandroid.MainMenuHamburguer
import com.prilux.playgatewayandroid.R
import com.prilux.playgatewayandroid.databinding.ActivityMainLoginBinding
...
class LoginMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /* TO TESTING */
        /*loginUserData.user = "imasduser"
        loginUserData.password = "123qwe"
        loginUserData.tenant = "PriluxImasD"
        loginUserData.isRememberAccess = true
        loginUserData.setCurrentUser(this, loginUserData)
        */
        ...
        binding.tenant.setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.ic_baseline_home_24, 0, 0, 0)
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                if (s.isNotEmpty()) {
                    ...
                    binding.email.setCompoundDrawablesWithIntrinsicBounds(
                        ...
                        null,
                        AppCompatResources.getDrawable(applicationContext, R.drawable.cancel),
                        null
                    )
        ...
        binding.password.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable) {
                ...
                if (s.isNotEmpty()) {
                    ...
                    DrawableCompat.setTint(
                        drawable!!,
                        getColor(R.color.colordarkblue)
        ...
        binding.developerModeImage.setOnClickListener {
            ...
            val dialog = AlertDialog.Builder(this)
                ...
                .setMessage(R.string.enable_developer_mode)
                ...
                .setPositiveButton(R.string.btn_aceptar) { _, _ ->
                    ...
                    if (editTextInput == "12345678") {
                        ...
                        Toast.makeText(this,R.string.proceso_correcto, Toast.LENGTH_SHORT).show()
                    } else {
                        Toast.makeText(this,R.string.proceso_fail, Toast.LENGTH_SHORT).show()
                    }
        ...
        binding.loginButton.setOnClickListener {
            if (LoginGlobalCredentials.user.user.isNotEmpty() &&
                ...
                dialogBuilder.setMessage(R.string.campos_vacios)
    ...
    private val loginTextWatcher: TextWatcher = object : TextWatcher {
        ...
        override fun afterTextChanged(s: Editable)
        {
            ...
            if (t)
            {
                binding.loginButton.setBackgroundResource(R.color.white)
            }
            else
            {
                binding.loginButton.setBackgroundResource(R.color.colorDefault)
            }
    ...
    private fun getTenantIdBLOCKING(): LoginErrorHandler {
        ...
        runBlocking {
            val job: Job = launch(context = Dispatchers.Default) {
                ...
                val account: AccountApi = AccountApi(LoginGlobalCredentials.basePathUrl)
                try {
    ...
    private fun authenticate(): LoginErrorHandler {
        ...
        runBlocking {
            val job: Job = launch(context = Dispatchers.Default) {
                val authModel: AuthenticateModel =
    ...
    private fun showAlert(mensaje: String) {
        ...
        val alert = dialogBuilder.create()
        // set title for alert dialog box
        alert.setTitle(getString(R.string.proceso_fail))
        // show alert dialog
        alert.show()
    }
